...
export default function Home() {
  return (
    <motion.div className="p-5" variants={routeAnimation} initial="initial" animate="animate" exit="exit">
      ...
      <div className="mb-9">
        <p className="text-sm justify text- lg:text-base">저는 설문조사 솔루션 스타트업에서 서비스 기획과 온라인 마케팅 업무를 시작으로 IT 회사에서의 첫 경험을 쌓았습니다. 출시 전 웹사이트 및 모바일 애플리케이션 개발 요구사항에 대한 기능 정리,
          서비스 플로우 와이어프레이밍, 케이스 시나리오 작성, 기능 테스트를 담당했고, 서비스 출시 후 GA와 Firebase를 이용하여 주요 KPI(웹사이트&모바일앱)를 트래킹하고 개선하는 업무에 임했습니다. 스타트업에 몸담는 동안 개발 지식에 대한 필요성을 절실히 느끼고 현재는
