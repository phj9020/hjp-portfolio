...
function Sidebar() {
    return (
        <div>
            ...
            <div className="flex items-center my-3 text-green-500 justify-evenly">
            ...
            <button onClick={()=> window.open('mailto:phj9020@hotmail.com')} className="w-8/12 py-2 my-2 text-white rounded-full bg-gradient-to-r from-green to-blue-400">Email me</button>
            <button className="w-8/12 py-2 my-2 text-white rounded-full bg-gradient-to-r from-green to-blue-400">Toggle Theme</button>
        </div>
    )
}
