...
function Sidebar() {
    ...
    return (
        <div>
            ...
            <a className="block w-8/12 p-2 m-auto my-2 text-sm transition duration-700 ease-in-out bg-gray-200 rounded-lg dark:bg-lightgray dark:hover:bg-red-400 text-center-sm hover:bg-blue hover:text-white" href="/assets/[서비스 기획자]박한진 이력서.pdf" download="[서비스 기획자]박한진 이력서">이력서 다운로드</a>
